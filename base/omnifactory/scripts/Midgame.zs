...
assembler.recipeBuilder().inputs([<gregtech:meta_item_2:26184> * 2, <gregtech:meta_item_1:12184> * 4, <gregtech:frame_steel>]).outputs([<gregtech:turbine_casing:1>]).duration(200).EUt(16).buildAndRegister();
assembler.recipeBuilder().inputs([<gregtech:meta_item_2:26072> * 2, <gregtech:meta_item_1:12072> * 4, <gregtech:frame_titanium>]).outputs([<gregtech:turbine_casing:2>]).duration(400).EUt(16).buildAndRegister();
