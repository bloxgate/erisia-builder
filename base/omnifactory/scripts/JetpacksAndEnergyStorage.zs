...
val fluidsolidifier = RecipeMap.getByName("fluid_solidifier");
...
recipes.addShapeless(<redstonearsenal:material> * 9, [<ore:dustElectrum>,<ore:dustElectrum>,<ore:dustElectrum>,<ore:dustElectrum>,<ore:dustElectrum>,<ore:dustElectrum>,<thermalfoundation:material:102>,<thermalfoundation:material:101>,<ore:dustMana>]);
...
// JetpacksAndEnergyStorage.zs:62
recipes.remove(<enderio:block_cap_bank:2>);	
...
autoclave.recipeBuilder().inputs([<minecraft:diamond>]).fluidInputs([<liquid:redstone> * 720]).outputs([<redstonearsenal:material:160>]).duration(200).EUt(400).buildAndRegister();
...
recipes.addShaped(<enderio:item_material:65>, [[<gregtech:meta_item_1:32680>],[<gregtech:meta_item_1:14705>]]);
...
alloy.recipeBuilder().inputs([<gregtech:meta_item_1:14704>,<enderio:item_material:20>]).outputs([<enderio:item_material:71>]).duration(200).EUt(30).buildAndRegister();
alloy.recipeBuilder().inputs([<enderio:item_alloy_ingot:8>,<enderio:item_material:20> * 8]).outputs([<enderio:item_alloy_endergy_ingot:3>]).duration(200).EUt(2000).buildAndRegister();
alloy.recipeBuilder().inputs([<enderio:item_material>,<enderio:item_material:20> * 2]).outputs([<enderio:item_material:1>]).duration(200).EUt(30).buildAndRegister();
alloy.recipeBuilder().inputs([<enderio:item_material:1>,<gregtech:meta_item_1:12712> * 8]).outputs([<enderio:item_material:66>]).duration(800).EUt(30).buildAndRegister();
alloy.recipeBuilder().inputs([<minecraft:quartz> * 3]).outputs([<enderio:block_fused_quartz>]).duration(80).EUt(16).buildAndRegister();
...
autoclave.recipeBuilder().inputs([<minecraft:diamond>]).fluidInputs([<liquid:pulsating_iron> * 144]).outputs([<enderio:item_material:14>]).duration(100).EUt(30).buildAndRegister();
autoclave.recipeBuilder().inputs([<minecraft:emerald>]).fluidInputs([<liquid:vibrant_alloy> * 144]).outputs([<enderio:item_material:15>]).duration(200).EUt(30).buildAndRegister();
autoclave.recipeBuilder().inputs([<minecraft:stone>]).fluidInputs([<liquid:water> * 250]).outputs([<extrautils2:decorativesolid:2>]).duration(100).EUt(4).buildAndRegister();
autoclave.recipeBuilder().inputs([<minecraft:stone:1>]).fluidInputs([<liquid:water> * 250]).outputs([<minecraft:stone:2>]).duration(100).EUt(4).buildAndRegister();
autoclave.recipeBuilder().inputs([<minecraft:stone:3>]).fluidInputs([<liquid:water> * 250]).outputs([<minecraft:stone:4>]).duration(100).EUt(4).buildAndRegister();
autoclave.recipeBuilder().inputs([<minecraft:stone:5>]).fluidInputs([<liquid:water> * 250]).outputs([<minecraft:stone:6>]).duration(100).EUt(4).buildAndRegister();
autoclave.recipeBuilder().inputs([<gregtech:meta_item_1:8202>]).fluidInputs([<liquid:water> * 250]).outputs([<appliedenergistics2:material>]).duration(80).EUt(16).buildAndRegister();
recipes.remove(<appliedenergistics2:quartz_vibrant_glass>);
alloy.recipeBuilder().inputs([<appliedenergistics2:quartz_glass>,<enderio:item_alloy_ingot:2>]).outputs([<appliedenergistics2:quartz_vibrant_glass>]).duration(80).EUt(16).buildAndRegister();
alloy.recipeBuilder().inputs([<gregtech:meta_item_2:26033>,<enderio:item_material:20> * 2]).outputs([<enderio:item_material:11>]).duration(100).EUt(16).buildAndRegister();
alloy.recipeBuilder().inputs([<enderio:item_material:11>,<enderio:item_alloy_ingot:6> * 4]).outputs([<enderio:item_material:73>]).duration(150).EUt(16).buildAndRegister();
alloy.recipeBuilder().inputs([<enderio:item_material:11>,<enderio:item_alloy_ingot:1> * 4]).outputs([<enderio:item_material:12>]).duration(150).EUt(16).buildAndRegister();
alloy.recipeBuilder().inputs([<enderio:item_material:12>,<enderio:item_alloy_ingot:2> * 4]).outputs([<enderio:item_material:13>]).duration(200).EUt(16).buildAndRegister();
alloy.recipeBuilder().inputs([<enderio:item_material:1>,<enderio:item_material:74> * 8]).outputs([<enderio:item_material:53>]).duration(200).EUt(16).buildAndRegister();
alloy.recipeBuilder().inputs([<enderio:item_material:1>,<simplyjetpacks:metaitemmods:3>]).outputs([<enderio:item_material:54>]).duration(2000).EUt(30).buildAndRegister();
...
alloy.recipeBuilder().inputs([<thermalexpansion:frame:130>, <minecraft:redstone_block> * 2]).outputs([<thermalexpansion:frame:146>]).duration(500).EUt(480).buildAndRegister();
alloy.recipeBuilder().inputs([<thermalexpansion:frame:131>, <minecraft:redstone_block> * 4]).outputs([<thermalexpansion:frame:147>]).duration(1000).EUt(2000).buildAndRegister();
alloy.recipeBuilder().inputs([<thermalexpansion:frame:132>, <minecraft:redstone_block> * 8]).outputs([<thermalexpansion:frame:148>]).duration(2000).EUt(8000).buildAndRegister();
	
	
	
<thermalexpansion:cell>.withTag({Recv: 4000, RSControl: 0 as byte, Facing: 4 as byte, Creative: 0 as byte, Energy: 0, Level: 1 as byte, SideCache: [2, 1, 1, 1, 1, 1] as byte[] as byte[], Send: 4000}).displayName = "Hardened Energy Cell";
<thermalexpansion:cell>.withTag({Recv: 9000, RSControl: 0 as byte, Facing: 4 as byte, Creative: 0 as byte, Energy: 0, Level: 2 as byte, SideCache: [2, 1, 1, 1, 1, 1] as byte[] as byte[], Send: 9000}).displayName = "Reinforced Energy Cell";
<thermalexpansion:cell>.withTag({Recv: 16000, RSControl: 0 as byte, Facing: 4 as byte, Creative: 0 as byte, Energy: 0, Level: 3 as byte, SideCache: [2, 1, 1, 1, 1, 1] as byte[] as byte[], Send: 16000}).displayName = "Signalum Energy Cell";
<thermalexpansion:cell>.withTag({Recv: 25000, RSControl: 0 as byte, Facing: 4 as byte, Creative: 0 as byte, Energy: 0, Level: 4 as byte, SideCache: [2, 1, 1, 1, 1, 1] as byte[] as byte[], Send: 25000}).displayName = "Resonant Energy Cell";
...
recipes.addShaped(<thermalexpansion:frame:128>, [
	...
	[<gregtech:meta_item_1:14035>, <enderio:block_cap_bank:3>, <gregtech:meta_item_1:14035>], 
	[<gregtech:meta_item_1:12035>, <gregtech:meta_item_1:14035>, <gregtech:meta_item_1:12035>]]);
recipes.remove(<thermalexpansion:cell>);
alloy.recipeBuilder().inputs([<thermalexpansion:frame:128>, <minecraft:redstone_block>]).outputs([<thermalexpansion:cell>.withTag({Recv: 10000, Level: 0 as byte, Send: 10000})]).duration(500).EUt(30).buildAndRegister();
