if (FML.isModLoaded("BiblioCraft") && Bibliocraft_enabled) {
    ...
    NEI.override("BiblioCraft:BiblioPaneler", [0, 6]);
    ...
    NEI.override("BiblioCraft:BookcaseFilled", [0, 6]);
    NEI.override("BiblioCraft:BiblioPotionShelf", [0, 6]);
    NEI.override("BiblioCraft:BiblioShelf", [0, 6]);
    NEI.override("BiblioCraft:BiblioRack", [0, 6]);
